...
final class Version20251015062314 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contrat_pret ADD CONSTRAINT FK_1FB83C67CF11D9C FOREIGN KEY (eleves_id) REFERENCES eleves (id)');
